    ...
    return (
        <header className='flex justify-between items-center px-5 py-3 w-100 shadow-md border-b1 bg-white z-50'>
            <div className='flex gap-x-2 items-center'>
                <Link to={'/'} className='flex gap-x-3 items-center hover:opacity-80 me-2'>
                    ...
                    <div className='hidden lg:block'>
                        <h1 className='text-black font-bold text-3xl'>Plus</h1>
                        <small className='text-black font-bold text-2xl'>Pizza</small>
                    </div>
                </Link>

                {
                    authUser.user?.isAdmin ?
                        (<Link to={'/admin_area'} className="bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-3 rounded">
                            Admin area
                        </Link>) :
                        (<></>)
                }
            ...
            <div className='flex gap-x-2'>
                {authUser.user ? (
                    <Link to={'/cart'} className="bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-3 rounded">
