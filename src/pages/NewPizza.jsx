...
import pic from '../assets/images/pizza-calabresa.jpg';
...
const NewPizza = () => {
  ...
  return (
    ...
    <div className='page-container '>
      ...
      <Link to={'/admin_area'} className='bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded-2xl'>
