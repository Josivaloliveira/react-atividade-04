  ...
  return (
    <div className='page-container'>
      ...
      <form onSubmit={handleForm} className="bg-white p-4  rounded border border-orange-500 w-100 lg:w-96 text-center m-auto shadow-md">
        ...
        <button disabled={loading} type="submit" className="bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded w-full flex items-center justify-center">
          Sign in
