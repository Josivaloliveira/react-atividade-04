...
const Pizza = () => {
      ...
      return (
        <div>
          ...
          <div className='text-end'>
            <button onClick={finishOrder} className='bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded-lg w-full'>
              Finish order
            </button>
          </div>
  ...
  return (
    ...
    <div className='page-container '>
      ...
      <Link to={'/'} className='bg-orange-500 hover:bg-orange-700 text-black font-bold py-2 px-4 rounded-2xl'>
